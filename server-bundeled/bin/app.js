...
const   http            = require('http'),
        ...
        ComponentA       = require('../../server-micro-a'),
        ComponentB       = require('../../server-micro-b'),
...
// Attach the component routers

app.use(config.get('publicPath') + '/:publication', componentA.router);
app.use(config.get('publicPath') + '/:publication', componentB.router);
